...
struct UpdateOTPView: View {
    ...
    @ObservedObject private var viewModel: UpdateVerificationViewModel
    init(phone:String,viewModel: UpdateVerificationViewModel) {
        self.phone = phone
    ...
    func handleResponse(){
            ...
            viewModel.VerifyAccount(urlEndPoint: .activeUpdatePhone, methodType: .post, parameters: .init(auth: phone, code: code, device_token: Helper.getFcmtoken() ?? "", type: "ios"))
    ...
    private func resendCode() {
        ...
        viewModel.ResendCode(urlEndPoint: .updatePhone, methodType: .post, parameters: .init(phone: phone))
